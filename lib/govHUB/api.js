...
// τα πεδία του source object στο target object παραλλάζοντας τα ονόματα των
...
gh.carGet = (data, conf, callback) => {
	...
	try {
		data.oxima = data.oxima.toString().toUpperCase();
	}
...
gh.carProcess = (oxima, data, callback) => {
	...
	if (oxima.oxima != vehicle.arithmosKykloforias)
