...
// Ορίζουμε την κλάση "Dimas.astinomikos" που απεικονίζει τους δηομτικούς
// αστυνομικούς.

Dimas.astinomikos = function(obj) {
	pd.objectInit(this, obj);
};

Dimas.astinomikos.fromAstinomikosList = function(s) {
	let a = s.split(//);

	return new Dimas.astinomikos({
		"kodikos": a[0],
		"onomateponimo": a[1],
	});
};
