...
//	
//	GH = require(`${process.env.CHT_BASEDIR}/lib/govHUB/carget.js`);
//	GH.confRead(`${process.env.CHT_BASEDIR}/private/govHUB.cf`, (cfs) => {
//		GH.tokenGet(JSON.parse('{' + cfs + '}'), (oxima) => {
//			console.log(oxima.katoxos.length);
//		});
//	});
...
govHUB.carGet = (line, conf, callback) => {
	var data;
