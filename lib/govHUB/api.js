...
gh.katoxos.prototype.eponimoSet = function(eponimo) {
	return pd.colvalSet.call(this, 'eponimo', eponimo);
};

gh.katoxos.prototype.diefSet = function(dief) {
	if (dief === this.perioxi)
	dief = undefined;

	return pd.colvalSet.call(this, 'dief', dief);
};

gh.katoxos.prototype.diefGet = function() {
	return pd.colvalGet.call(this, 'dief');
};
