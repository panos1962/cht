...
gh.prosopo.prototype.fromGsis = function(rsp, gsisData) {
	return gh.fromPlatform(rsp, 'prosopo', this, gsisData, {
		...
		// TODO
		// Οι παρακάτω properties πρέπει να εξεταστούν καθώς μπορεί
		// να περιέχουν χρήσιμη πληροφορία. Προστέθηκαν κάποια
		// στιγμή μεταξύ 2020 και 2021 και δεν γνωρίζω τι περιέχουν.

		"residenceMunicipalityTin": false,
		"residenceMunicipalityFullName": false,
		"eponymo": false,
		"eponymoB": false,
		"onoma": false,
		"patronymo": false,
...
gh.tokenGet = function(conf, what, callback, noMore) {
	...
	request.post({
		...
		// Η flag "reject_unauthorized" τίθεται false προκειμένου να
		// μην εκληφθεί ως σφάλμα η απάντηση από τον server ότι δεν
		// είμαστε πιστοποιημένοι, ή ότι έχει λήξει κάποιο δικό μας
		// πιστοποιητικό κλπ. Την ίδια τακτική ακολουθούμε και σε
		// άλλες παρόμοιες κλήσεις του παρόντος προγράμματος.
...
gh.txId = '93a08920-b309-4abf-8d93-fea271135162';
gh.protonum = Math.round(Date.now() / 1000) % 10000000;
