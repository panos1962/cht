...
w3srv.createServer = () => {
	...
	try {
		if (!w3srv.opts.conf.connect.w3srv.hasOwnProperty('protocol'))
		w3srv.opts.conf.connect.w3srv.protocol = 'http';

		if (!w3srv.opts.conf.connect.w3srv.hasOwnProperty('portNumber'))
		w3srv.opts.conf.connect.w3srv.portNumber = 8001;
	}
	...
	switch (w3srv.opts.conf.connect.w3srv.protocol) {
	case 'https':
