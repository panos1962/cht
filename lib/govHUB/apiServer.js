...
gh.prosopo.prototype.onomasiaFix = function() {
	// Σε μη μονοπρόσωπες εταιρείες υπάρχει το πεδίο "eteria" και άλλα
	// συναφή πεδία. Σε αυτές τις περιπτώσεις προβαίνουμε σε διόρθωση
	// και απαλοιφή των σχετικών πεδίων.
