...
carget.readOxima = (conf) => {
	...
	.on('line', (line) => {
		if (line === '')
		return console.log(carget.endMark);
...
// callback function. Απαραίτητη προϋπόθεση για να λειτουργήσει η "processInput"
// είναι να περιλαμβάνεται property "input", η οποία με τη σειρά της πρέπει να
// περιλαμβάνει:
//
...
carget.processInput = (x, callback) => {
	...
	// της API function "carGet". Η εν λόγω function θα προσθέσει στο
