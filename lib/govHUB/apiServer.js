...
// ως «πλατφόρμα». Στο παρόν ορίζονται επίσης και δομές αντικειμένων που
// αφορούν στην πλατφόρμα, π.χ. φυσικά/νομικά πρόσωπα, οχήματα, κάτοχοι
// οχημάτων κλπ.
//
// Updated: 2019-12-29
// Updated: 2019-12-24
...
gh.prosopo.prototype.imerominiaFix = function() {
	try {
		this.genisi = pd.date(pd.ISO2date(this.genisi));
	}
