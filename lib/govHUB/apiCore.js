...
// Η μέθοδος "kiriosKatoxosIndexGet" επιστρέφει το index του κυρίου κατόχου
// οχήματος, όπου «κύριος κάτοχος» θεωρείται είτε ο μοναδικός κάτοχος του
// οχήματος, είτε ο πρώτος τη τάξει από αυτούς που κατέχουν το υψηλότερο
// ποσοστό συνιδιοκτησίας. Στην περίπτωση που το όχημα δεν διαθέτει κατόχους,
// η μέθοδος επιστρέφει undefined.

gh.oxima.prototype.kiriosKatoxosIndexGet = function() {
	let idx = undefined;
	let pos = 0;
